...
class Iface(object):
    def getPersonByName(self, username):
        """
        Parameters:
         - username
...
class Client(Iface):
    ...
    def getPersonByName(self, username):
        ...
        """
        self.send_getPersonByName(username)
        return self.recv_getPersonByName()

    def send_getPersonByName(self, username):
...
class Processor(Iface, TProcessor):
    ...
    def process_getPersonByName(self, seqid, iprot, oprot):
        ...
        result = getPersonByName_result()
        try:
            result.success = self._handler.getPersonByName(args.username)
